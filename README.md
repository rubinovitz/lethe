...
SMS wrapper for Redis. Based heavily on the [Twilio-Hackpack-for-Heroku-and-Flask](https://github.com/RobSpectre/Twilio-Hackpack-for-Heroku-and-Flask) by Rob Spectre.


## Installation

Step-by-step on how to deploy, configure and develop 

### Getting Started 

1) Grab latest source
<pre>
git clone https://github.com/rubinovitz/lethe.git 
</pre>
